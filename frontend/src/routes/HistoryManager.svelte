<script>
    ...
    import HistoryRowManager from "../components/HistoryRowManager.svelte";
      ...
      <Tabs.Root value={selectedTab} onValueChange={(value) => { selectedTab = value; currentPage = 1; }}>
        ...
        <Tabs.Content value="approved">
          <Card.Root>
            ...
            <Card.Footer class="flex justify-between items-center">
              <div class="text-muted-foreground text-xs">
                Showing <strong>{startIndex + 1}-{endIndex}</strong> of <strong>{sortedRequests.length}</strong> approved requests
              </div>
              <div class="flex gap-2">
                <Button
                  variant="outline"
        ...
        <Tabs.Content value="rejected">
          <Card.Root>
            ...
            <Card.Footer class="flex justify-between items-center">
              <div class="text-muted-foreground text-xs">
                Showing <strong>{startIndex + 1}-{endIndex}</strong> of <strong>{sortedRequests.length}</strong> rejected requests
              </div>
              <div class="flex gap-2">
                <Button
                  variant="outline"
